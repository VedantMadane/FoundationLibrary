Namespace WebPackages


    Public Class HTMLPACKING
        Public Structure HTMLTAG
            ...
            Structure HTMLATTRIBUTES
                Dim idiothta As String
                Dim Eltrans As String
                Dim Perigrafh As String
                Dim syndesmos As String
                Dim values() As HTMLATTRIBUTESVALUE
                Structure HTMLATTRIBUTESVALUE
                    Dim onoma As String
                    Dim ellinika As String
                    Dim perigrafh As String
                End Structure
            End Structure
            Structure EventsScript
                Dim onoma As String
                Dim Ellinika As String
                Dim Perigrafh As String
            End Structure
        End Structure
        Public packHTML(109) As HTMLTAG
        Dim GlobalAttributes(13) As HTMLTAG.HTMLATTRIBUTES
        Dim Events(31) As HTMLTAG.EventsScript
        Sub New()
#Region "Global Attriibutes"
